...
public class AsynctaskTwitter extends AsyncTask<String, Void, String> {
    ...
    public AsynctaskTwitter(Activity act) {
        this.act = act;
    }
    ...
    private String getUrl() {
        url = "http://ec2-52-59-251-0.eu-central-1.compute.amazonaws.com:8080/api/users/save_twittertoken";
        return (url);
    }
    ...
    private String getConnexion(String url, String... params) { //creat json param a l api avec le chemin
        ...
        try {
            ...
            json.put("secret_token", params[1]);
